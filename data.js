...
const PORTFOLIO = {
  ...
  meta: {
    ...
    phone:        "+91-9492454800",
    github:       "https://github.com/amalkumar-ak",
  ...
  projects: [
    {
      featured: true,
      icon:  "🏗️",
      title: "Terraform on Azure — Multi-Env CI/CD Pipeline",
      description: "Production-style Infrastructure-as-Code delivery pipeline for Microsoft Azure. A single Terraform codebase is promoted across <strong>dev → qa → uat → prod</strong> via Azure DevOps Pipelines with per-environment <code>.tfvars</code>, isolated remote state in Azure Blob Storage, approval gates on Apply/Destroy, and plan-as-artifact for zero drift. Includes an idempotent state-backend bootstrap script and modular Terraform (Resource Group, Storage Account, VNet).",
      url:   "https://github.com/amalkumar-ak/terraform-infra",
      ...
      chips: ["🏗️ IaC", "🔄 Multi-Env", "🛡️ Approval Gates", "🗄️ Remote State"],
    },
    {
      featured: false,
      icon:  "🧹",
      title: "Azure VM Snapshot Cleanup Automation",
      description: "Automated Azure Managed Disk snapshot lifecycle across multiple landing zones. Two Azure DevOps pipelines — <strong>Friday simulation preview</strong> + <strong>Saturday real cleanup</strong> — driven by a shared PowerShell worker script. Owners opt out with a <code>DoNotDelete=True</code> tag. Produces per-LZ and consolidated CSV reports and emails them to the ops distribution list.",
      url:   "https://github.com/amalkumar-ak/SnapShot-Cleanup",
      ghLabel: "🐙 Code ↗",
      tags: [
        { label: "PowerShell",   color: "#5391FE" },
        { label: "Azure DevOps", color: "#0969da" },
      ...
      chips: ["🧹 Cost Optimization", "📅 Scheduled", "📧 Email Reports", "🏷️ Tag Opt-out"],
    },
    {
      featured: false,
      icon:  "⏰",
      title: "VM Auto Start/Stop — Tag-Based Runbook",
      description: "Azure Automation PowerShell runbook that scans all VMs in a subscription and starts/stops them based on an <code>AutoShutdownSchedule</code> tag applied at VM or Resource Group level. Uses System-Assigned Managed Identity, supports multi-window schedules, midnight-crossing ranges, weekends, and specific dates — with a Simulate mode for safe testing.",
      url:   "https://github.com/amalkumar-ak/VM-Auto-ShutDown",
      ghLabel: "🐙 Code ↗",
      tags: [
        { label: "Azure Automation", color: "#0078d4" },
        { label: "PowerShell",       color: "#5391FE" },
        { label: "Managed Identity", color: "#3fb950" },
      ],
      chips: ["💰 Cost Savings", "🏷️ Tag-Driven", "🕐 Scheduled", "☁️ Serverless"],
    },
    {
      featured: false,
      icon:  "⏳",
      title: "3-Tier Architecture — Coming Soon…",
      description: "Building an end-to-end 3-tier web application on Azure — <strong>NGINX</strong> reverse proxy, <strong>Node.js</strong> frontend, <strong>FastAPI</strong> backend, and <strong>SQL</strong> database — deployed via Terraform and Azure DevOps pipelines with observability baked in. Watch this space! ⭐",
      url:   "",           // empty = card is not clickable
      ghLabel: "",
      tags:  [],
      chips: ["🌐 NGINX", "🟩 Node.js", "⚡ FastAPI", "🗄️ SQL", "🏗️ Terraform"],
  ...
  contact: {
    ...
    links: [
      ...
      { icon: "🐙", label: "GitHub",    value: "github.com/amalkumar-ak",           href: "https://github.com/amalkumar-ak", external: true },
